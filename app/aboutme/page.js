...
var posts = [
    {
        ...
        author: {
            ...
            href: '#',
            imageUrl: 'https://scontent-nrt1-1.cdninstagram.com/v/t51.2885-19/338456968_574040998031439_5058197959390537795_n.jpg?stp=dst-jpg_s320x320&_nc_ht=scontent-nrt1-1.cdninstagram.com&_nc_cat=103&_nc_ohc=nsmCRgbtwUwAX9j9M48&edm=AOQ1c0wBAAAA&ccb=7-5&oh=00_AfAVV9gdSEHUc44OtEq3H-WGmvij26kvzcie0occ8dyUrQ&oe=65199CCF&_nc_sid=8b3546',
        },
    },
];
function AboutMe() {
    return (<div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map(function (post) { return (<article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
